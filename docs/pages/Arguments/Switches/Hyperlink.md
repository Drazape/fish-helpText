...
## Permanent Arguments
Initial
:   The command specified is always ran with the explicitly specified arguments as the initial ones.

Immutable
:   After specified, these explicit arguments do not change, and are always provided each time it is ran, for any purpose.
